						...
						<div class="form group">
							<div class="row">
								<div class="col-lg-12">
									...
									<input type="file" name="excel" class="form-control" required="" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"><br>
