            ...
            <div class="col-lg-8 posts-list">
               <div class="single-post">
                  <div class="blog_details">
                     <form method="post" action="{{route('cekLatihan', $name->id_tax)}}">
                     @csrf
                        ...
                        @endforeach
                         <h5>
                            ...
                            @else
                                <a class="btn_2" href="{{Route('pembahasan_soal.show', $name->id_tax)}}">Pembahasan</a>
                            @endif
                        </h5>
                        ...
                        <div class="progress mx-auto" data-value="{{ Session::get('popup') }}">
                            ...
                            <div
                                ...
                                <div class="font-weight-bold pt-3" style="font-size: 30px">
                                    <h1>{{ Session::get('popup') }}<small style="font-size: 20px">%</small></h1>
                                </div>
                            </div>
                        </div>
