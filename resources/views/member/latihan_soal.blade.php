                        ...
                        @foreach($exercise as $data)
                            ...
                            <label for="default-radio">
                                ...
                                <h5 style="line-height: 30px">
                                    {{$data->question}}<br>
                                    @if($data->image != null)
                                    <img src="{{asset('storage/images/latihan_soal_image/'.$data->image)}}">
                                    @else
                                    @endif
                                </h5>
                            </label>
                            
                            <label class="container2"><h5 style="line-height: 30px; margin-left: 10px">A. {{$data->option_a}}</h5>
                                <input type="radio" name="{{$data->id}}" value="1">
                                <span class="checkmark"></span>
                            </label>
                            <label class="container2"><h5 style="line-height: 30px; margin-left: 10px">B. {{$data->option_b}}</h5>
                                <input type="radio" name="{{$data->id}}" value="2">
                                <span class="checkmark"></span>
                            </label>
                            <label class="container2"><h5 style="line-height: 30px; margin-left: 10px">C. {{$data->option_c}}</h5>
                                <input type="radio" name="{{$data->id}}" value="3">
                                <span class="checkmark"></span>
                            </label>
                            <label class="container2"><h5 style="line-height: 30px; margin-left: 10px">D. {{$data->option_d}}</h5>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                @if(Session::get('popup') < 25 ) <h2 style="text-align: center;">Sangat Buruk!</h2><br>
                    ...
                    @elseif(Session::get('popup') < 50 ) <h2 style="text-align: center;">Kurang Bagus!
                        </h2><br>
