               ...
               <div class="single-post">
                  <div class="blog_details">
                        ...
                        @foreach($answer as $data)
                            ...
                            <!-- pembahasan soal -->
                            @if(!empty($data->exerciseQuestion->exerciseQuestionSolution->solution))
                            <div class="quote-wrapper">
                                <div class="quotes">
                                    ...
                                    <a src="{{asset('storage/images/pembahasan_soal/'.$data->exerciseQuestion->exerciseQuestionSolution->image)}}" target="_blank">
                                    <img id="gambar" src="{{asset('storage/images/pembahasan_soal/'.$data->exerciseQuestion->exerciseQuestionSolution->image)}}">
                                    </a>
                                    @else
                                    @endif
                            ...
                            @else
                                <b>MOHON MAAF, PEMBAHASAN BELUM TERSEDIA</b><br>
                            @endif
