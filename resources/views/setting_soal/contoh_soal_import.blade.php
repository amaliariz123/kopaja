<!--begin::Modal-->
<div class="modal fade" id="import_contoh_soal"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						...
						<div class="form group">
							<div class="row">
								<div class="col-lg-12">
									...
									<a href="{{url('contoh_soal/import/download')}}" style="margin-top: 15px" class="btn btn-sm btn-info"><i class="la la-download"></i> Unduh Template</a><br>
								</div>
							</div>
						</div>
					</fieldset>
